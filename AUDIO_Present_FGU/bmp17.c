...
//  N=117*121;
    ...
    printf("This program is to extract the audio data of the WAV file of %s\n",argv[1]);
    printf("and generate the sampled audio values into a file out.data\n");
      ...
      for ( i=0; i <4; i++ )
	{
     ...
     printf("Starting reading data now at this position...!\n\n\n");
